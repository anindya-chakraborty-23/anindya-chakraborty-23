...
- 📫 How to reach me: [LinkedIn](https://www.linkedin.com/in/anindya-chakraborty-iimb/) — DMs open
- 😄 Pronouns: He/Him
...
This GitHub is a working portfolio of AI tools, prompts, notebooks, and accelerators — primarily at the intersection of **supply chain**, **energy and utilities**, and **enterprise AI**.

You'll find:

- 🤖 **Claude / LLM accelerators** — practical tools and patterns for applying large language models in enterprise contexts
- 📦 **Supply chain AI use cases** — demand sensing, supplier risk, KPI analysis, and SaaS platform augmentation
...
`Claude API` &nbsp; `Python` &nbsp; `Jupyter Notebooks` &nbsp; `Supply Chain SaaS Platforms` &nbsp; `Power BI`

---

*This portfolio is actively being built. New projects added regularly.*
